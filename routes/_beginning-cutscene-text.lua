return function() 
return {
[ 1 ] = { [[  Something does not feel quite right. You had been dozing off, in the
...
[ 2 ] = { [[  You stand on a large set of rolling plains, the sky above you is
  speckled with numerous stars that dimly light up the landscape. At a
  point in the distance you see shimmering light.]] },
[ 3 ] = { [[  As you appear to have no other recourse, you begin to walk toward this
  ...
  more and more.]] },
[ 4 ] = { [[  After some time you begin to doubt that you will ever reach the source
...
[ 5 ] = { [[  When you turn forward again, you are shocked to see that the light has,
  somehow, gone from very far away to very close.]] },
[ 6 ] = { [[  You can see it clearly now. The light comes from what looks like a
