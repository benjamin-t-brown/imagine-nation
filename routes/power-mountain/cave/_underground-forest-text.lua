return function() 
return {
 [ 1 ] = { [[  You see stream winding its way through this passage, extruding out of
...
,[ 2 ] = { [[  The stream is very shallow and you have no problem skipping over it.
  ...
  room.]] }
,[ 3 ] = { [[  You approach the tree.]] }
,[ 4 ] = { [[  It appears to be dead. Its wood is dry, and its roots seem to be
  withering.]] }
,[ 5 ] = { [[  At second glance, though, you notice something rather odd: the stream
  brushes up against one of the tree's roots, yet somehow the root is
  still extremely dry.]] }
,[ 6 ] = { [[  How strange! Upon closer inspection, you see that the stream actually
